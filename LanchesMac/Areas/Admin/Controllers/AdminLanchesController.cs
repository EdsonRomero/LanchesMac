...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.Cateogrias, "CategoriaId", "CategoriaNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] Lanche lanche)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Cateogrias, "CategoriaId", "CategoriaNome", lanche.CategoriaId);
            return View(lanche);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Lanche'  is null.");
            }
            var lanche = await _context.Lanche.FindAsync(id);
            if (lanche != null)
            {
